...
st.set_page_config(
    ...
    # Optional: add your own favicon for share/link icon (ensure file exists)
...
# -----------------------------
# Header (logo in tile, works on Streamlit Cloud)
# -----------------------------
...
# -----------------------------
# Auto Refresh selector (Off/5/10/20) default 10s
# -----------------------------
...
# -----------------------------
# Stint timeline: markers only (no busy text)
# -----------------------------
